...
void Bureaucrat::executeForm(AForm const & form) const
{
    ...
    {
        std::cerr << "Bureaucrat " << this->_name << " has not executed " << form.getName() << " because form is not signed." << std::endl;
    }
    catch(const AForm::GradeTooLowException& e)
    {
        std::cerr << "Bureaucrat " << this->_name << " has not executed " << form.getName() << " because bureaucrat has too low grade." << std::endl;
    }
}
